    ...
    public class FilesPageViewModel : ReactiveObject
    {
        ...
        public static IMultiValueConverter FileIconConverter
        {
            get
            {
                ...
                {
                    using (var fileStream = AssetLoader.Open(new Uri("avares://Dalfsen/Assets/file.png")))
                    using (var folderStream = AssetLoader.Open(new Uri("avares://Dalfsen/Assets/folder.png")))
                    using (var folderOpenStream = AssetLoader.Open(new Uri("avares://Dalfsen/Assets/folder-open.png")))
                    {
