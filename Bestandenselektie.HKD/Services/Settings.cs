...
namespace Bestandenselektie.HKD.Services
{
    public class Settings : IJsonOnDeserialized
    {
        public Settings()
        {
            ...
            Rubrieken = new List<Rubriek>();
            Categorieen = new List<string>();
            Collecties = new List<string>();
            Plaatsen = new List<string>();
        }
        ...
        public IList<string> Collecties { get; set; }
        public IList<string> Plaatsen { get; set; }
    }
}
